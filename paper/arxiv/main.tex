...
That the i.i.d.\ assumption fails on real text is not new;
\citet{fernandez2023bricks} showed it and proposed corrected statistics. What has
not been shown is how large the failure is, that its size and sign are set by the
key, that it grows with length, that it survives on human-written text, and what
correcting it costs in detection. Those are this paper's contributions, in order
